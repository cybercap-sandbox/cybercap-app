...
describe("Test image generation playground", function () {
  beforeEach(() => {
  ...
  it("Checks submit the form with a prompt to api and showing mock image, save user request, save image to S3 bucket request and save image data to db request", function () {
